...
const GiftCouponCard = () => {
  const [userInputCode, setUserInputCode] = useState('');
    const {coupon, isCouponApplied, removeCoupon, getMyCoupon, applyCoupon} = useCartStore();
  ...
  return (
    ...
    >
      <div className='space-y-4'>
        <div>
          <label htmlFor="voutcher" className='mb-2 block text-sm font-medium text-gray-300'>
